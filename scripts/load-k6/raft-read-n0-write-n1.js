...
// 기본 테스트 URL
const NODE_URLS = {
    node0: "http://localhost:18080",
    node1: "http://localhost:28080",
    node2: "http://localhost:38080",
};
...
export default function () {
    ...
    const response = sse.open(
        `${NODE_URLS["node0"]}/sse?apikey=1234567890`,
        params,
        function (client) {
...
function callAfterEndpoint(client, path) {
    let id = 0;
    let endpoint = `${NODE_URLS["node1"]}${path}`;
